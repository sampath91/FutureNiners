						...
						<nav id="filter" class="col-md-12 text-center">
							<ul>
								...
								<li><a href="#" class="btn-theme btn-small"
									data-filter=".webdesign">Development</a></li>
								<li><a href="#" class="btn-theme btn-small"
									data-filter=".photography">Designing</a></li>
										...
										<div class="portfolio-item">
											...
											<div class="portfolio-desc align-center">
												<div class="folio-info">
													<a href="index.php" class="fancybox">
														<h3>Dept Name</h3>
														<h3>Dept Head</h3>
														<h4>Contact</h4> <i class="fa fa-link fa-2x"></i>
													</a>
												</div>
											</div>
										</div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="footerwidget">
							...
							<div class="contact-info">
								...
								<i class="fa fa-phone"></i>+00 123 156 711 <br> <i
									class="fa fa-envelope-o"></i> youremail@email.com
							</div>
						</div>
						<!-- end widget -->
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6 panel">
						<div class="panel-body">
							<p class="simplenav">
								<a href="index.php">Home</a> | <a href="about.php">About</a> | <a
									href="courses.php">Courses</a> | <a href="price.php">Price</a>
								| <a href="videos.php">Videos</a> | <a href="contact.php">Contact</a>
							</p>
						</div>
					</div>
