...
from Department where DeptName = '$SearchDept');";
	...
	if (mysqli_num_rows ( $result ) > 0) {
		...
		echo "<div>  <table class=\"table table-bordered table-hover\"  width=\"64\" summary=\"Table\"
			 border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
			<tr align=\"left\" valign=\"top\" >
    <td>CourseID</td><td>COURSE_TITLE</td>
    <td>CREDIT_HOURS</td></tr>";
		while ( $row = mysqli_fetch_assoc ( $result ) ) {
			
			echo "<tr align=\"left\" valign=\"top\" >
    <td>" . $row ["CourseID"] . "</td><td>" . $row ["COURSE_TITLE"] . "</td>		
    <td>" . $row ["CREDIT_HOURS"] . "</td></tr>";
		}
		echo "</table></div>";
	} else {
